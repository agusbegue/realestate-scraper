    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.CharField(default='-', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posts_found', models.IntegerField(blank=True)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.ScrapyJob')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
